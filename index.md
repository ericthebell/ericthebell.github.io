...
<div class ="row-block">
	<div class="row-text">
		<strong>{{ last_role.position }}</strong>
		<p><em>{{ last_role.date | date: "%Y %b" }}</em><br/>
		{{ last_role.excerpt | markdownify }}</p>
	</div>
	<div class="row-thumb">
		<img src="{{ last_role.thumbnail | default: '/assets/images/erik_viki.png' }}" alt="{{ last_role.company }}">
	</div>
</div>
{% endif %}
<hr>
...
<div class="row-block">
	...
	<div class="row-thumb">
		<img src="{{ recent_talk.thumbnail | default: '/assets/images/erik_viki.png' }}" alt="{{ last_role.company }}">
	</div>
</div>
{% endif %}
<hr>
